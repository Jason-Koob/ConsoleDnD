...
tprint("Choosing your\ncharacter class", font="Cybermedium")
...
time.sleep(5)
print("\n\n--------- Artificer -------")
print("Masters of invention, artificers use ingenuity and magic to unlokc extraordinary capabilities in objects.\nHit Die: d8\nPrimary Ability: Intelligence\nSaves: Constitution & Intelligence")
...
elif option == "Warlock" or option == "warlock":
    playerInfo.Class = "Warlock"
elif option == "Sorcerer" or option == "sorcerer":
    playerInfo.Class = "Sorcerer"
elif option == "Rogue" or option == "rogue":
    playerInfo.Class = "Rogue"
elif option == "Ranger" or option == "ranger":
    playerInfo.Class = "Ranger"
elif option == "Paladin" or option == "paladin":
    playerInfo.Class = "Paladin"
elif option == "Monk" or option == "monk":
    playerInfo.Class = "Monk"
elif option == "Fighter" or option == "fighter":
    playerInfo.Class = "Fighter"
elif option == "Druid" or option == "druid":
    playerInfo.Class = "Druid"
elif option == "Cleric" or option == "cleric":
    playerInfo.Class = "Cleric"
elif option == "Bard" or option == "bard":
    playerInfo.Class = "Bard"
elif option == "Barbarian" or option == "barb":
    playerInfo.Class = "Barbarian"
elif option == "Artificer" or option == "artificer":
